...
const data = [{
        image_background: 'assets/image/photo-1.jpg',
    ...
    {
        image_background: 'assets/image/photo-26.jpg',
        ...
        comment: "“I've never used a theme as versatile and flexible as Landkit. It's my go to for building landing sites on almost any project.”",
        name: "RUSS D'SA",
    },
...
data.map(el => {
    slide_list = document.getElementById("slide-list");
    slide_list.innerHTML += '<div class = "myslide"><div class="slide-item">' +
        '<div class="image">' +
        '<img src="' +
        el.image_background +
        '" alt=""></div>' +
        '<div class = "content-wrap"><div class="content"><div class="icon">' +
        el.icon +
    ...
    dots.innerHTML += '<div class="dot-item active"><i class="fas fa-rectangle-wide"></i></div>';
...
function showSlides(n) {
    ...
    // let content = slides[slideIndex].getElementsByClassName("content");
    // content[0].style.transform = "translateX(100%)";
    // content[0].style.transition = "transform 1s";


    for (i = 0; i < slides.length; i++) {
        let image = slides[i].getElementsByClassName("image");
        image[0].style.opacity = "0";
        let content = slides[i].getElementsByClassName("content");
    ...
    let image = slides[slideIndex - 1].getElementsByClassName("image");
    image[0].style.opacity = "1";
    image[0].style.transition = "0.6s ease";
    let content = slides[slideIndex - 1].getElementsByClassName("content");
    ...
    if (slideIndex > slides.length) {
        ...
        dotItem[slideIndex - 1].classList.add('active');
    }
